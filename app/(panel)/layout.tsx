...
import { LayoutDashboard, Globe, Cpu, Container, Database, Archive, ScrollText, Settings as SettingsIcon, Menu, Rocket, SquareTerminal, FolderOpen, Clock, Shield, type LucideIcon } from 'lucide-react';
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: 'terminal', icon: SquareTerminal, href: '/terminal' },
  { id: 'files', icon: FolderOpen, href: '/files' },
